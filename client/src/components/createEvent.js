...
export default function CreateEvent() {
  ...
  async function create_event() {
    ...
    const contract = getContract(account,provider);
    ...
    try {
      ...
      // we get the fecth data function for the event fro the ethereum event 
      //let data = await fetchData(transactionHash, 2);
      let creator = "0x677144b19931B53ccb87b1946490a9341E7ae78C"; //data[0].value;
      let eventIndex = 0 //toDecimal(data[1].value);
